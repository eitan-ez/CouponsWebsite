...
public class AdminService extends ClientService {
	...
	public void deleteCustomer(int id) throws ServiceException {
		Optional<Customer> opt = custRep.findById(id);
		if (opt.isEmpty())
			throw new ServiceException("customer with id " + id + "don't exist");
	...
	/**
	 * Checks if a customer is null or contains null objects (firstName, lastName,
	 * email, password). Returns true if null or contains null, returns false if no
	 * null was found.
	 */
